...
class AppData {
    ...
    start() {
        ...
        localStorage.setItem('addExpenсes', JSON.stringify(this.addExpenсes.join(', ')));
        localStorage.setItem('addIncome', JSON.stringify(this.addIncome.join(', ')));
        localStorage.setItem('targetMonth', JSON.stringify(this.period));
        localStorage.setItem('incomePeriod', JSON.stringify(this.calcSavedMoney()));
        ...
        document.cookie = 'addExpenсes=' + this.addExpenсes.join(', ');
    ...
    showResult() {
        ...
        additionalExpensesValue.value = JSON.parse(localStorage.getItem('addExpenсes'));
        additionalIncomeValue.value = JSON.parse(localStorage.getItem('addIncome'));
        targetMonthValue.value = JSON.parse(localStorage.getItem('targetMonth'));
        incomePeriodValue.value = JSON.parse(localStorage.getItem('incomePeriod'));
...
if (JSON.parse(localStorage.getItem('budgetMonth')) !== null) {
    appData.showResult();
    appData.toggleButton();
    appData.blockTextInputs();
};
